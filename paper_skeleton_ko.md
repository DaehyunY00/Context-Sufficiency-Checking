...
## 6. 문장 톤 체크리스트 (대한산업공학회용)
1. 추상적 평가어 대신 수치와 조건을 함께 제시한다.
2. 문장 종결은 `~하였다`, `~한다`를 혼용하지 않고 절 내 일관성을 유지한다.
3. 한 문단에서 하나의 주장만 다루고, 다음 문장에서 근거 수치를 제시한다.
4. 한계는 숨기지 않고 독립 소절로 분리한다.
